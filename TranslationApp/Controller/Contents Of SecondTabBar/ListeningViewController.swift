...
class ListeningViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewWillAppear(_: Bool) {
        ...
        GetDocument.getDocumentsForTimeline(user: user, topic: "リスニング", listener: self.listener) { postArray in
...
extension ListeningViewController: MFMailComposeViewControllerDelegate {
