//
//  OthersBookMarkCommentsSectionViewController.swift
//  TranslationApp
//
...
class OthersBookMarkCommentsSectionViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
