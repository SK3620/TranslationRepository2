...
class GrammerViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewWillAppear(_: Bool) {
        ...
        GetDocument.getDocumentsForTimeline(user: user, topic: "文法", listener: self.listener) { postArray in
...
extension GrammerViewController: MFMailComposeViewControllerDelegate {
