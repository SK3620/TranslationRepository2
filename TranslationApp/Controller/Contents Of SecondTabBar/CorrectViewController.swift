...
class CorrectViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewWillAppear(_: Bool) {
        ...
        GetDocument.getDocumentsForTimeline(user: user, topic: "修正/教えて", listener: self.listener) { postArray in
...
extension CorrectViewController: MFMailComposeViewControllerDelegate {
