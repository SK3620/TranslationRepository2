...
class EditRecordViewController: UIViewController, UINavigationBarDelegate {
    ...
    override func viewDidLoad() {
        ...
        if self.translationFolderArr.count != 0 {
            for number in 0 ... self.translationFolderArr.count - 1 {
                self.folderNames.append(self.translationFolderArr[number].folderName)
            }
        }
...
//        デフォルト設定
        ...
        self.textField1.layer.borderWidth = 2
        self.textField1.layer.borderColor = color
        self.textField1.layer.cornerRadius = 6

        self.textField2.layer.borderWidth = 2
        self.textField2.layer.borderColor = color
        self.textField2.layer.cornerRadius = 6

        self.textField3.layer.borderWidth = 2
        self.textField3.layer.borderColor = color
        self.textField3.layer.cornerRadius = 6

        self.textField4.layer.borderWidth = 2
        self.textField4.layer.borderColor = color
        self.textField4.layer.cornerRadius = 6

        self.textView1.layer.borderWidth = 2
        self.textView1.layer.borderColor = color
